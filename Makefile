...
#                                                    +#+                       #
#    Created: 2021/11/21 13:37:15 by abeznik       #+#    #+#                  #
#    Updated: 2021/11/21 13:55:18 by abeznik       ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
clean:
				@$(RM) $(DIR_OBJS)
				@printf "$(_RED) '"$(DIR_OBJS)"' has been deleted. $(_END)\n"

fclean:			clean
				@$(RM) $(NAME)
				@printf "$(_RED) '"$(NAME)"' has been deleted. $(_END)\n"
